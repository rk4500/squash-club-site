/**
 * The 2026-27 ladder draw: 32 players, no bye.
 *
 * Ported verbatim from the standalone ladder-v2.html. Everything the bracket
 * renders is a pure function of MATCHES plus the recorded results, so this
 * file is the single place a draw change has to happen.
 *
 * A side is one of:
